...
public class PlayerWeaponSkillController_Template : PlayerWeaponSkillController
{
    ...
    public override void NormalAttack()
    {
        if (Animator.GetCurrentAnimatorStateInfo(0).IsName("Idle"))
        {
            ...
            shield.transform.position = new Vector3(20, 20, 20);
            var controller = shield.GetComponent<BackpackController>();
    ...
    {
        WithinShield = true;
        Animator.Play("Sword And Shield Block");
