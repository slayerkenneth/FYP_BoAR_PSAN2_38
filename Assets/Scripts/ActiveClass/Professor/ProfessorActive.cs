...
public class ProfessorActive : ActiveClass
{
    ...
    public override void skill(GameObject player) {
        ...
        {   
            ...
            Vector3 temp_position = new Vector3(player.transform.localPosition.x + randomIndex, player.transform.localPosition.y, player.transform.localPosition.z + randomIndex);
